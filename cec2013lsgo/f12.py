"""
F12: Shifted Rosenbrock Function / 位移 Rosenbrock 函数.

CEC 2013 大规模全局优化基准测试函数 F12。
CEC 2013 Large-Scale Global Optimization Benchmark Function F12.
...
class F12(Benchmarks):
    ...
    CEC 2013 基准测试函数 F12，使用 Rosenbrock 函数。
    CEC 2013 benchmark function F12 using Rosenbrock function.

    Attributes:
        ID: 函数标识符 / Function identifier (12)
    ...
    def __init__(self) -> None:
        """初始化 F12 函数 / Initialize F12 function."""
        super().__init__()
        self.ID = 12
    ...
    def compute(self, x: Union[npt.NDArray, List]) -> npt.NDArray:
        """
        计算 F12 函数值 / Compute F12 function value.

        逻辑: Global Shift -> Rosenbrock
